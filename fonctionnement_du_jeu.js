document.addEventListener("DOMContentLoaded", () => {
  ...
  let phrase = [
    ...
    "Je suis le professeur pokémon du pays de Malo-Malo ! Et je suis... imcompétent !!",
    "Je me demande comment va mon frère M. Tonneau. Vu l'heure, il doit se faire cuire un oeuf.",
    "Le savais-tu ? Grotadamour est l'un des premiers pokémon mémorables du jeune dresseur Emerick.",
    ...
    "Mon pokémon préféré, c'est Stonneleau ! Parce qu'il ressemble à un tonneau, et moi, je m'appelle professeur Tonneau !... Mais, qui de nous deux est arrivé le premier ? Qui est le VRAI tonneau ???",
    "Mmmh.. J'ai la musique du Centre pokémon dans la tête.",
    ...
    "Dans ma jeunesse, j'avais les cheveux noirs. Si, si, cette information est utile pour ton apprentissage du dressage de pokémon, je t'assure.",
    ...
    "Le pokémon qui est actuellement en tête de ton équipe est un QUELORIOR ! Alors ? Alors ? J'ai bon ??",
    "Le pokémon qui est actuellement en tête de ton équipe est un PONYTA ! Alors ? Alors ? J'ai bon ??",
    "Le pokémon qui est actuellement en tête de ton équipe est un ARCEUS ! Alors ? Alors ? J'ai bon ??",
    "Au fond de moi sommeille un tigre, grrrRRrrr. Grrr ! Grrr ! GRRRRRRRRRRRRRRRR !!!!!!!",
    "Roooonn..... Zzzzzzzzzzzzzzzzzzz",
    "Je suis le professeur pokémon de tout le pays de Malo-Malo. Pour être tout à fait honnête, je me demande parfois comment j'ai pu avoir ce poste. Mais je dis rien et je me fais oublier. Jusqu'à maintenant, ça a marché.",
    "Il y a longtemps, je faisais du tourisme à Abricot : ils organisaient une fête sur le thème des pokémon, pour fêter l'ouverture d'une nouvelle pension ! C'est fou, tout le monde aime les pokémon !",
    "J'ai toujours du mal à donner un pokémon de départ à mes nouveaux élèves. Ils font comment les autres professeurs pour toujours avoir trois pokémon costauds et introuvables dans la nature ?? Moi, je n'ai que des magicarpes et des amplégnées à proposer, c'est tout, et encore, c'est quand j'arrive à les capturer, hein !",
  ...
  function Start(){//jeSuisChromatique
    valeur = Math.floor(Math.random() * 301)
    lettre = "p";
    if (valeur==1){
      lettre = "c";
